...
public class HerokuCli {
	...
	// On Linux
	public static String cliDirMac = "/usr/local/bin/heroku";
	
	// War repository 
	public static String warName = "HerokuDemo.war";
	public static String warPath;
	// On Windows
	public static String warRepoWindows = "D:";
	// On Linux
	public static String warRepoLinux = "/home/trinhlk/Desktop";
	// On Mac
	public static String warRepoMac = "/Users/trinhlk/Desktop";
