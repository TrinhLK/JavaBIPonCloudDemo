...
public class MonitorConnector_4 extends HttpServlet
{
...
//		String content = requestJson(SwitchConnector.currentServer);
	    ...
	    System.out.println("[Monitor_4-addDB] Check URL: " + baseUrl);
	    URL url;
		try {
			url = new URL(baseUrl);
			System.out.println("[Monitor_4] Check URL: " + baseUrl);
