...
@Ports({  
//	@Port(name = "selfloop", type = PortType.enforceable),
	@Port(name = "transition1", type = PortType.enforceable),
	@Port(name = "transition2", type = PortType.enforceable),
	})
@ComponentType(initial = "0", name = "org.javabip.executor.test.TransitionTrigger.component2")
public class component2 {
	
	String componentName = "COMPONENT 2";
